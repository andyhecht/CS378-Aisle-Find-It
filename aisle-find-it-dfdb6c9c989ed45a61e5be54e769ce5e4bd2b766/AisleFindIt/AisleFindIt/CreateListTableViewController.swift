...
class CreateListTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell:ListTableViewCell = tableView.dequeueReusableCellWithIdentifier("CreateListCell", forIndexPath: indexPath) as! ListTableViewCell
        cell.editing = true
        
        let row = indexPath.row
        if(list[row] != ""){
            cell.item.text = list[row]
        }
