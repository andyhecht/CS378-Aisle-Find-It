...
//  AisleFindIt
//
//  Created by Andrew Hecht on 10/18/16.
...
class MainScreenTableViewController: UITableViewController {
    ...
    let ChooseStoreSegueIdentifier = "ChooseStoreSegueIdentifier"
    
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if  segue.identifier == ChooseStoreSegueIdentifier{
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = self.tableView.dequeueReusableCellWithIdentifier("MainCell", forIndexPath: indexPath)
